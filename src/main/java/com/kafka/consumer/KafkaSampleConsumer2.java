...
public class KafkaSampleConsumer2 {
    ...
    static void runConsumer() {
        ...
        while (true) {
            ...
            consumerRecords.forEach(record -> {
               // log.info("Record Key " + record.key(), "Record value " + record.value(), "Record partition " + record.partition(),
        ...
        public static Consumer<Long, String> createConsumer() {
            ...
            props.put(ConsumerConfig.GROUP_ID_CONFIG, KafkaConstants.GROUP_ID_CONFIG_2);
